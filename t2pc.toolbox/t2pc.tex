...
\@x{}%
\@y{%
 * \ensuremath{ZHENG} \ensuremath{KAI} \ensuremath{50247576 \.{\stst}
}}%
\@xx{}%
\@x{}%
\@y{%
 * \ensuremath{XINBO} \ensuremath{YU} \ensuremath{50102922 \.{\stst}
}}%
\@xx{}%
\@x{ {\EXTENDS} Integers ,\, Sequences ,\, FiniteSets ,\, TLC}%
\@x{ {\CONSTANT} RM ,\, RMMAYFAIL ,\, TMMAYFAIL}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} t2pc {\p@lbrace}}%
 \@x{\@s{16.4} {\p@variable} rmState \.{=} [ rm \.{\in} RM
 \.{\mapsto}\@w{working} ] {\p@semicolon}}%
\@x{\@s{59.62} tmState\@s{0.89} \.{=}\@w{init} {\p@semicolon}}%
\@x{\@s{16.4} {\p@define} {\p@lbrace}}%
 \@x{\@s{32.8} canCommit \.{\defeq} \A\, rm \.{\in} RM \.{:} rmState [ rm ]
 \.{\in} \{\@w{prepared} ,\,\@w{committed} \}}%
 \@x{\@s{32.8} canAbort \.{\defeq} \E\, rm \.{\in} RM \.{:}\@s{4.1} rmState [
 rm ]\@s{6.99} \.{\in} \{\@w{aborted} ,\,\@w{failed} \} \.{\land} tmState
 \.{\neq}\@w{committed}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@macro} Prepare {\p@lparen} p {\p@rparen} {\p@lbrace}}%
\@x{\@s{32.8} {\p@await} rmState [ p ] \.{=}\@w{working} {\p@semicolon}}%
\@x{\@s{63.14} rmState [ p ] \.{:=}\@w{prepared} {\p@semicolon}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@macro} Decide {\p@lparen} p {\p@rparen} {\p@lbrace}}%
 \@x{\@s{32.8} {\p@either} {\p@lbrace} {\p@if} {\p@lparen} rmState [ p ]
 \.{=}\@w{prepared} \.{\land} tmState \.{=}\@w{committed} {\p@rparen}}%
\@x{\@s{32.8} {\p@lbrace}}%
\@x{\@s{69.7} rmState [ p ] \.{:=}\@w{committed}}%
\@x{\@s{69.7} {\p@rbrace}}%
\@x{\@s{32.8} {\p@rbrace}}%
 \@x{\@s{32.8} {\p@or} {\p@lbrace} {\p@if} {\p@lparen} rmState [ p ] \.{\in}
 \{\@w{working} \} \.{\lor} ( ( rmState [ p ] \.{=}\@w{prepared} ) \.{\land}
 ( tmState \.{=}\@w{aborted} ) ) {\p@rparen}}%
\@x{\@s{32.8} {\p@lbrace}}%
\@x{\@s{69.7} rmState [ p ] \.{:=}\@w{aborted}}%
\@x{\@s{69.7} {\p@rbrace}}%
\@x{\@s{32.8} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@macro} Fail {\p@lparen} p {\p@rparen} {\p@lbrace}}%
\@x{\@s{32.8} {\p@if} {\p@lparen} RMMAYFAIL {\p@rparen} {\p@lbrace}}%
\@x{\@s{51.64} {\p@either} rmState [ p ] \.{:=}\@w{failed} {\p@semicolon}}%
\@x{\@s{51.64} {\p@or} {\p@skip} {\p@semicolon}}%
\@x{\@s{32.8} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
 \@x{\@s{16.4} {\p@fair} {\p@process} {\p@lparen} RManager \.{\in} RM
 {\p@rparen} {\p@lbrace}}%
 \@x{\@s{32.8} RS\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen} rmState [ self
 ] \.{\in} \{\@w{working} ,\,\@w{prepared} \} {\p@rparen} {\p@lbrace}}%
 \@x{\@s{65.49} {\p@either} Prepare ( self ) {\p@or} Decide ( self ) {\p@or}
 Fail ( self )}%
\@x{\@s{32.8} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
 \@x{\@s{16.4} {\p@fair} {\p@process} {\p@lparen} TManager \.{=} 0 {\p@rparen}
 {\p@lbrace}}%
 \@x{\@s{32.8} TS\@s{.5}\textrm{:}\@s{3} {\p@either} {\p@lbrace} {\p@await}
 canCommit {\p@semicolon}}%
 \@x{\@s{53.05} TC\@s{.5}\textrm{:}\@s{3} tmState \.{:=}\@w{committed}
 {\p@semicolon}}%
 \@x{\@s{53.05} F1\@s{.5}\textrm{:}\@s{3}\@s{2.90} {\p@if} {\p@lparen}
 TMMAYFAIL {\p@rparen} tmState \.{:=}\@w{hidden} {\p@semicolon} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{32.8} {\p@or} {\p@lbrace} {\p@await} canAbort {\p@semicolon}}%
 \@x{\@s{51.21} TA\@s{.5}\textrm{:}\@s{3} tmState \.{:=}\@w{aborted}
 {\p@semicolon}}%
 \@x{\@s{51.21} F2\@s{.5}\textrm{:}\@s{3}\@s{0.96} {\p@if} {\p@lparen}
 TMMAYFAIL {\p@rparen} tmState \.{:=}\@w{hidden} {\p@semicolon} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 \ensuremath{TM} backup
}%
\@xx{}%
 \@x{\@s{16.4} {\p@fair} {\p@process} {\p@lparen} TManagerBackup \.{=} 1
 {\p@rparen} {\p@lbrace}}%
 \@x{\@s{32.8} L1\@s{.5}\textrm{:}\@s{3} {\p@await} \.{\lor} TMMAYFAIL
 \.{\land} tmState \.{=}\@w{hidden}}%
\@x{\@s{80.69} \.{\lor} {\lnot} TMMAYFAIL {\p@semicolon}}%
 \@x{\@s{32.8} {\p@if} {\p@lparen} tmState \.{=}\@w{hidden} {\p@rparen}
 {\p@lbrace}}%
\@x{\@s{51.64} TS\@s{.5}\textrm{:}\@s{3} {\p@either} {\p@lbrace}}%
\@x{\@s{71.89} {\p@await} canCommit {\p@semicolon}}%
 \@x{\@s{71.89} TC\@s{.5}\textrm{:}\@s{3} tmState \.{:=}\@w{committed}
 {\p@semicolon}}%
\@x{\@s{51.64} {\p@rbrace}}%
\@x{\@s{51.64} {\p@or} {\p@lbrace}}%
\@x{\@s{70.06} {\p@await} canAbort {\p@semicolon}}%
 \@x{\@s{70.06} TA\@s{.5}\textrm{:}\@s{3} tmState \.{:=}\@w{aborted}
 {\p@semicolon}}%
\@x{\@s{51.64} {\p@rbrace}}%
\@x{\@s{32.8} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
...
\@x{}%
\@y{\@s{0}%
 Label \ensuremath{TS} of process \ensuremath{TManager} at line 48 col 13
 changed to \ensuremath{TS\_
}}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 Label \ensuremath{TC} of process \ensuremath{TManager} at line 49 col 17
 changed to \ensuremath{TC\_
}}%
\@xx{}%
\@x{}%
\@y{\@s{0}%
 Label \ensuremath{TA} of process \ensuremath{TManager} at line 53 col 17
 changed to \ensuremath{TA\_
}}%
\@xx{}%
\@x{ {\VARIABLES} rmState ,\, tmState ,\, pc}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 define statement
...
\@xx{}%
 ...
 \@x{ canAbort \.{\defeq} \E\, rm \.{\in} RM \.{:}\@s{4.1} rmState [ rm
 ]\@s{6.99} \.{\in} \{\@w{aborted} ,\,\@w{failed} \} \.{\land} tmState
 \.{\neq}\@w{committed}}%
\@pvspace{16.0pt}%
\@x{ vars \.{\defeq} {\langle} rmState ,\, tmState ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} ( RM ) \.{\cup} \{ 0 \} \.{\cup} \{ 1 \}}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@x{\@s{160.39} {\Box}\@s{10.30} self \.{=} 0 \.{\rightarrow}\@w{TS\_}}%
\@x{\@s{160.39} {\Box}\@s{10.30} self \.{=} 1 \.{\rightarrow}\@w{L1} ]}%
\@pvspace{8.0pt}%
\@x{ RS ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{RS}}%
 ...
 self ] \.{=}\@w{prepared} ]}%
 \@x{\@s{122.89} \.{\lor} \.{\land} \.{\lor} \.{\land} {\IF} rmState [ self ]
 \.{=}\@w{prepared} \.{\land} tmState \.{=}\@w{committed}}%
 \@x{\@s{179.49} \.{\THEN} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT}
 {\bang} [ self ] \.{=}\@w{committed} ]}%
\@x{\@s{179.49} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{210.80} \.{\land} {\UNCHANGED} rmState}%
 \@x{\@s{145.12} \.{\lor} \.{\land} {\IF} rmState [ self ] \.{\in}
 \{\@w{working} \} \.{\lor} ( ( rmState [ self ] \.{=}\@w{prepared} )
 \.{\land} ( tmState \.{=}\@w{aborted} ) )}%
 \@x{\@s{179.49} \.{\THEN} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT}
 {\bang} [ self ] \.{=}\@w{aborted} ]}%
\@x{\@s{179.49} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{210.80} \.{\land} {\UNCHANGED} rmState}%
...
\@x{\@s{57.21} \.{\land} {\UNCHANGED} tmState}%
\@pvspace{8.0pt}%
\@x{ RManager ( self ) \.{\defeq} RS ( self )}%
\@pvspace{8.0pt}%
\@x{ TS\_\@s{1.78} \.{\defeq} \.{\land} pc [ 0 ] \.{=}\@w{TS\_}}%
\@x{\@s{39.15} \.{\land} \.{\lor} \.{\land} canCommit}%
 \@x{\@s{61.37} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0 ]
 \.{=}\@w{TC\_} ]}%
\@x{\@s{50.26} \.{\lor} \.{\land} canAbort}%
 \@x{\@s{61.37} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0 ]
 \.{=}\@w{TA\_} ]}%
 \@x{\@s{39.15} \.{\land} {\UNCHANGED} {\langle} rmState ,\, tmState
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ TC\_ \.{\defeq} \.{\land} pc [ 0 ] \.{=}\@w{TC\_}}%
\@x{\@s{39.15} \.{\land} tmState \.{'} \.{=}\@w{committed}}%
 \@x{\@s{39.15} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0 ]
 \.{=}\@w{F1} ]}%
\@x{\@s{39.15} \.{\land} {\UNCHANGED} rmState}%
\@pvspace{8.0pt}%
\@x{ F1 \.{\defeq} \.{\land} pc [ 0 ] \.{=}\@w{F1}}%
\@x{\@s{31.74} \.{\land} {\IF} TMMAYFAIL}%
\@x{\@s{55.01} \.{\THEN} \.{\land} tmState \.{'} \.{=}\@w{hidden}}%
\@x{\@s{55.01} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{86.32} \.{\land} {\UNCHANGED} tmState}%
 \@x{\@s{31.74} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0 ]
 \.{=}\@w{Done} ]}%
\@x{\@s{31.74} \.{\land} {\UNCHANGED} rmState}%
\@pvspace{8.0pt}%
\@x{ TA\_ \.{\defeq} \.{\land} pc [ 0 ] \.{=}\@w{TA\_}}%
\@x{\@s{37.21} \.{\land} tmState \.{'} \.{=}\@w{aborted}}%
 \@x{\@s{37.21} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0 ]
 \.{=}\@w{F2} ]}%
\@x{\@s{37.21} \.{\land} {\UNCHANGED} rmState}%
\@pvspace{8.0pt}%
\@x{ F2 \.{\defeq} \.{\land} pc [ 0 ] \.{=}\@w{F2}}%
\@x{\@s{31.74} \.{\land} {\IF} TMMAYFAIL}%
\@x{\@s{55.01} \.{\THEN} \.{\land} tmState \.{'} \.{=}\@w{hidden}}%
\@x{\@s{55.01} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{86.32} \.{\land} {\UNCHANGED} tmState}%
...
\@x{\@s{31.74} \.{\land} {\UNCHANGED} rmState}%
\@pvspace{8.0pt}%
 \@x{ TManager \.{\defeq} TS\_ \.{\lor} TC\_ \.{\lor} F1 \.{\lor} TA\_
 \.{\lor} F2}%
\@pvspace{8.0pt}%
\@x{ L1\@s{4.49} \.{\defeq} \.{\land} pc [ 1 ] \.{=}\@w{L1}}%
 \@x{\@s{34.65} \.{\land} \.{\lor} TMMAYFAIL \.{\land} tmState
 \.{=}\@w{hidden}}%
\@x{\@s{45.76} \.{\lor} {\lnot} TMMAYFAIL}%
\@x{\@s{34.65} \.{\land} {\IF} tmState \.{=}\@w{hidden}}%
 \@x{\@s{57.91} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 1
 ] \.{=}\@w{TS} ]}%
 \@x{\@s{57.91} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 1
 ] \.{=}\@w{Done} ]}%
 \@x{\@s{34.65} \.{\land} {\UNCHANGED} {\langle} rmState ,\, tmState
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ TS\@s{1.78} \.{\defeq} \.{\land} pc [ 1 ] \.{=}\@w{TS}}%
\@x{\@s{34.65} \.{\land} \.{\lor} \.{\land} canCommit}%
 \@x{\@s{56.87} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 1 ]
 \.{=}\@w{TC} ]}%
\@x{\@s{45.76} \.{\lor} \.{\land} canAbort}%
 ...
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ TC \.{\defeq} \.{\land} pc [ 1 ] \.{=}\@w{TC}}%
\@x{\@s{34.65} \.{\land} tmState \.{'} \.{=}\@w{committed}}%
 \@x{\@s{34.65} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 1 ]
 \.{=}\@w{Done} ]}%
\@x{\@s{34.65} \.{\land} {\UNCHANGED} rmState}%
\@pvspace{8.0pt}%
\@x{ TA\@s{1.94} \.{\defeq} \.{\land} pc [ 1 ] \.{=}\@w{TA}}%
\@x{\@s{34.65} \.{\land} tmState \.{'} \.{=}\@w{aborted}}%
 \@x{\@s{34.65} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 1 ]
 \.{=}\@w{Done} ]}%
\@x{\@s{34.65} \.{\land} {\UNCHANGED} rmState}%
\@pvspace{8.0pt}%
\@x{ TManagerBackup \.{\defeq} L1 \.{\lor} TS \.{\lor} TC \.{\lor} TA}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} TManager \.{\lor} TManagerBackup}%
...
\@x{\@s{39.83} \.{\land} {\WF}_{ vars} ( TManagerBackup )}%
\@pvspace{8.0pt}%
...
\@xx{}%
\@x{}\midbar\@xx{}%
 \@x{ Termination2 \.{\defeq} {\Diamond} ( \A\, self\@s{7.14} \.{\in} ProcSet
 \.{:} pc [ self ] \.{=}\@w{Done} )}%
 \@x{ Consistency \.{\defeq} \A\, rm1 ,\, rm2 \.{\in} RM \.{:} {\lnot} (
 rmState [ rm1 ] \.{=}\@w{aborted} \.{\land} rmState [ rm2 ]
 \.{=}\@w{committed} )}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{\stst} ZHENG} \ensuremath{KAI}
 \ensuremath{50247576 \.{\stst}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{\stst} XINBO} \ensuremath{YU}
 \ensuremath{50102922 \.{\stst}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* Part 1.\ensuremath{1
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Model check \ensuremath{Consistency} and
 \ensuremath{Termination} with \ensuremath{RMMAYFAIL\.{=}{\FALSE}} and
 \ensuremath{TMMAYFAIL\.{=}{\FALSE}},
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* it means that no \ensuremath{RM} fasle and
 no \ensuremath{TM} false, and there are no errors in my program.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Model check \ensuremath{Consistency} and
 \ensuremath{Termination} with \ensuremath{RMMAYFAIL\.{=}{\TRUE}} and
 \ensuremath{TMMAYFAIL\.{=}{\FALSE}},
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* it means that \ensuremath{RM} can be fasle
 and no \ensuremath{TM} false, not all \ensuremath{RMs} can change their
 status to committed, and there are no errors in my program.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* Part 1.\ensuremath{2
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Model check \ensuremath{Consistency} and
 \ensuremath{Termination} with \ensuremath{RMMAYFAIL\.{=}{\FALSE}} and
 \ensuremath{TMMAYFAIL\.{=}{\TRUE}},
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* it means that no \ensuremath{RM} fasle and
 \ensuremath{TM} will be false, and the \ensuremath{Termination} property
 will be violated.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* The error example is
 \ensuremath{rmState\.{<}\@w{aborted}}, \ensuremath{\@w{prepared}},
 \ensuremath{\@w{aborted}\.{>}} and \ensuremath{tmState \.{=} hidden}. When
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* \ensuremath{tmState} equals hidden, it
 doesn\mbox{'}t make a decison. When the \ensuremath{RMs} read the state of
 the \ensuremath{TM}, it can\mbox{'}t
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* return committed or aborted, so the
 \ensuremath{RMs} can\mbox{'}t change their state.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* Part 1.\ensuremath{3
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* When set \ensuremath{RMMAYFAIL}
 \ensuremath{{\TRUE}} and \ensuremath{TMMAYFAIL} \ensuremath{{\TRUE}}, model
 check \ensuremath{Consistency} and \ensuremath{Termination
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Both of them are not violated. Because when
 \ensuremath{TM} fail, the \ensuremath{RMs} can connect to the Backup
 \ensuremath{TM},
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* they can read the state of Backup
 \ensuremath{TM}, the Backup \ensuremath{TM} can reset the status of the tm,
 so the \ensuremath{RMs} can
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* change to their right final status according
 to \ensuremath{tmState}.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 05 11:17:23 \ensuremath{EST} 2017 by \ensuremath{xinboyu
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Tue}
 \ensuremath{Nov} 28 13:56:03 \ensuremath{EST} 2017 by kz-\ensuremath{pc
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sun \ensuremath{Nov} 26 15:42:50
 \ensuremath{EST} 2017 by \ensuremath{xinboyu
}%
\end{cpar}%
\end{lcom}%
\end{document}
